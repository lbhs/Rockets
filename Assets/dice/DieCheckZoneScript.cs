...
/*
	...
	void FixedUpdate ()
	{
		...
		if(DieScript.rolling == 1 && dieNumber != 0)
		{
            ...
            if (DieScript.totalRolls == 4 && GameObject.Find("TutorialMarker").GetComponent<TutorialScript>().Tutorial == true) //active if this is a tutorial round
            {
                dieNumber = 3;
                print("Tutorial fourth round = oxygen");
                GameObject.Find("ConversationDisplay").GetComponent<ConversationTextDisplayScript>().ChooseOxygenEB();
            }
